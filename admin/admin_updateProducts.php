                ...
                <div class="card shadow">
                    ...
                    <div class="card-body mb-3">
                        ...
                        ?>    
                            ...
                            <form action="admin_updateProducts.php" method="POST" enctype="multipart/form-data">   
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input class="form-control" type="text" name="productStatus" value="<?php echo $row['productStatus']; ?>">                                                   
                                    </div>
                                </div>
