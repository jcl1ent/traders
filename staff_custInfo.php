                                            ...
                                            if ($customer_result->num_rows > 0) {
                                                ...
                                                <form>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col">
                                                        <input class="form-control" type="text" value="<?php echo ucwords($fullName); ?>"  disabled readonly>                                                    
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col">
                                                        <input class="form-control" type="text" value="<?php echo ucwords($customer['address']); ?>"  disabled readonly>                                                    
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
