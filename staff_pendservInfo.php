                        ...
                        ?> 
                            <form>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input class="form-control" type="text" value="<?php echo htmlspecialchars(ucwords($row['customerName'])); ?>" disabled readonly>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col">
                                        <input class="form-control" type="text" value="<?php echo htmlspecialchars(ucwords($row['staffName'])); ?>" disabled readonly>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    <label for="staticCreateDate" class="col col-form-label">Accepted Date:</label>
                                    <div class="col">
                                        <input class="form-control" type="text" value="<?php echo htmlspecialchars($row['acceptedDate']); ?>" disabled readonly>
                                    </div>
                                </div>
