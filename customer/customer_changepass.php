...
if (isset($_POST['UpdatePass'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>window.location.href='" . url('customer/customer_changepass.php?userId=' . urlencode($userId)) . "';</script>";
        exit();
        }
        ...
        echo "<script>window.location.href='" . url('customer/dashboard.php') . "';</script>";
    }
}
?>
                                     ...
                                     if (isset($_GET['userId'])) {
                                         ...
                                         if ($result_role->num_rows > 0) {
                                             ...
                                             // Debugging: Check if role is retrieved successfully
                                                     ...
                                                     ?>
                                                     <form action="<?= url('customer/customer_changepass.php?userId=' . urlencode($userId)) ?>" method="POST" autocomplete="off">
                                                     ...
                                                     <a href="<?= url('customer/updateUserDetails.php?userId=' . urlencode($userId)) ?>" >
