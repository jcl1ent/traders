...
if (isset($_POST['submitReceipt'])) {
    ...
    if (isset($_POST['pymntNo']) && isset($_FILES['receipts'])) {
        $pymntNo = $_POST['pymntNo']; // Get paymentNo from the form submission
                                ...
                                <table id="dataTable" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_SESSION['email']) && isset($_SESSION['userId']) && isset($_SESSION['custId'])) {
                                            ...
                                            $query = "SELECT * FROM payment WHERE custId = ? AND orderNo IS NOT NULL AND orderNo != '' ORDER BY pymntNo DESC";
                                            $stmt = $con->prepare($query);
                                                ...
                                                while ($row = $result->fetch_assoc()) {                                                                
                                                    ...
                                                    <tr class="text-center">                                                                    
                                                        ...
                                                        <td data-label="Action">
                                                            ...
                                                            <a href="customer_paymentInfo2.php?pymntNo=<?php echo $row['pymntNo']; ?>">
                                                            ...
                                                            <a href="customer_payment_print.php?pymntNo=<?php echo $row['pymntNo']; ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="receiptUpload" class="form-label">Upload Payment Receipt (Max 3 images):</label>
