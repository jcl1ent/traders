                ...
                <div class="col">
                    <div class="card shadow">
                        <div class="card-header">                    
                            <div class="card-body">
                                <div class="addUser d-flex justify-content-end mb-3">
                                                 ...
                                                 if ($result_vCust->num_rows > 0) {
                                                    while ($row = $result_vCust->fetch_assoc()) {                                                                                                                      
                                                                ...
                                                                <tr class="text-center">
                                                                    ...
                                                                    <a href="user_info.php?userId=<?php echo $row['userId']; ?>">
                                                                        <button type="button" class="btn btn-primary bg-gradient">
                                                                            Details
                                                                        </button>
                                                                    </a>
                                                                    <a href="admin_updateUser.php?userId=<?php echo $row['userId']; ?>">
